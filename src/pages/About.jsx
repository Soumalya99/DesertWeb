      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <img src="https://images.pexels.com/photos/9491250/pexels-photo-9491250.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Desert Sunset" className="rounded-lg shadow-lg w-full" />
            </div>
          </div>
        </div>
      </section>
